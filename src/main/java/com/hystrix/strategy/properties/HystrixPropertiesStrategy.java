 ...
 */
package com.hystrix.strategy.properties;

import com.hystrix.HystrixCollapser;
import com.hystrix.HystrixCollapserKey;
import com.hystrix.HystrixCollapserProperties;
import com.hystrix.HystrixCommand;
import com.hystrix.HystrixCommandKey;
import com.hystrix.HystrixCommandProperties;
import com.hystrix.HystrixThreadPool;
import com.hystrix.HystrixThreadPoolKey;
import com.hystrix.HystrixThreadPoolProperties;
import com.hystrix.HystrixTimerThreadPoolProperties;
...
public abstract class HystrixPropertiesStrategy {
    ...
    /**
     * Construct an implementation of {@link com.hystrix.HystrixTimerThreadPoolProperties} for configuration of the timer thread pool
     * that handles timeouts and collapser logic.
     * <p>
     * Constructs instance of {@link HystrixPropertiesTimerThreadPoolDefault}.
     *
     *
     * @return Implementation of {@link com.hystrix.HystrixTimerThreadPoolProperties}
     */
